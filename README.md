...
Apply ControlNet on Latent Diffusion is to guide model to generate desired style of images. The condition used in this repo is Canny Map. Which generate by cv2 edge detection.
